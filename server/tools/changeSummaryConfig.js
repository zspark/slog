...
class ArticleConfig {
    ...
    constructor(fileName, obj) {
        ...
        this.#layout = obj ? obj[constant.M_TEMPLATE] : constant.M_TEMPLATE_DEFAULT;
        this.#allowHistory = obj ? (obj[constant.M_ALLOW_HISTORY] ? obj[constant.M_ALLOW_HISTORY] : true) : true;
        this.#secret = false;
    }
